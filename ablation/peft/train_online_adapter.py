...
# for idx in (tqdm(range(4000), desc=f"Training")):
    ...
    if idx % 1000 == 0 and idx > 0:
        ...
        pickle.dump(ppl, open(f'./checkpoints/eu_online_adapter.pkl', 'wb'))

# model.save_pretrained(f'./checkpoints/echr_online_adapterhot4000.pt')
ppl = {'train': ppl_all, 'test': test_ppl_all}
pickle.dump(ppl, open(f'./checkpoints/eu_online_adapter.pkl', 'wb'))
